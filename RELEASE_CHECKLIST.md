...
- [x] README synchronized: current version `2.1.0`, test count `503`, example count `16`.
- [x] Changelog synchronized with v2.1.0 release notes and historical logs preserved.
- [x] Test count synchronized across all documentation (`503 passed, 0 failed`).
- [x] Example count synchronized (`16 runnable examples`).
- [x] Full test suite completed (`503 passed in 11.35s`).
